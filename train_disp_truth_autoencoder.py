...
def plot_examples(model, x_val_norm, imu_val, mean_np, std_np, out_dir, max_examples=6):
...
def main():
    ...
    print(
        f"Disp truth windows: train={x_train.shape[0]} val={x_val.shape[0]} "
    ...
    if mode == "load":
        plot_examples(model, x_val_norm, imu_val, mean_np, std_np, output_dir)
        return
